        ...
        <div class="ml-[14rem]">
            ...
            <div class="my-8 mx-10">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div>
                        <a href="<?php echo base_url('admin/tambah_siswa') ?>" class="bg-cyan-500 py-2 px-6 font-semibold text-white rounded-sm">ADD</a>
                        <a href="<?php echo base_url('admin/export_siswa') ?>" class="bg-cyan-500 py-2 px-6 font-semibold text-white rounded-sm">EXPORT</a>
    ...
    <div id="defaultModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-6 space-y-6" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/import_siswa') ?>">
                    <div>
